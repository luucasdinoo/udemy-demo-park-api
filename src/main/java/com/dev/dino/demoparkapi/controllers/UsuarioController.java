...
public class UsuarioController {
    ...
    @Operation(summary = "Recuperar todos os usuários", description = "Recurso para recuperar todos os usuários", responses = {
    ...
    @Operation(summary = "Recuperar um usuário pelo id", description = "Recurso para recuperar um usuário pelo seu id", responses = {
            @ApiResponse(responseCode = "200",description = "Recurso recuperado com sucesso",content = @Content(mediaType = "application/json", schema = @Schema(implementation = UsuarioResponseDto.class))),
