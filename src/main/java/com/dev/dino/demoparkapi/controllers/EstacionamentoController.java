...
import com.dev.dino.demoparkapi.dto.mapper.ClienteVagaMapper;
...
import com.dev.dino.demoparkapi.services.ClienteVagaService;
import com.dev.dino.demoparkapi.services.EstacionamentoService;
import com.dev.dino.demoparkapi.services.JasperService;
...
public class EstacionamentoController {
    ...
    public ResponseEntity<PageableDto> getAllEstacionamentosDoClienteLogado(@AuthenticationPrincipal JwtUserDetails userDetails,
                                                                   @PageableDefault(size = 5, sort = "dataEntrada", direction = Sort.Direction.ASC) Pageable pageable){
